...
export async function getChannelMspId(params) {
  return request(prefix + `/channel/${params.channelId}`, {
    method: "GET",
    headers: {
      Authorization: localStorage.getItem("token")
    }
...
/* fabric用户 */
// 获取fabric用户基本信息
export async function getFabricUser() {
  return request(prefix + `/identity/user`, {
    method: "GET",
    headers: {
      Authorization: localStorage.getItem("token")
    }
...
// 新增fabric用户
export async function addFabricUser(params) {
  return request(prefix + `/identity/user`, {
    method: "POST",
    body: params,
    headers: {
...
// 更新fabric用户
export async function updateFabricUser(params) {
  return request(prefix + `/identity/user/${params.userId}`, {
    method: "PUT",
    body: params.data,
    headers: {
      Authorization: localStorage.getItem("token")
...
// 删除fabric用户
export async function deleteFabricUser(params) {
  return request(prefix + `/identity/user/${params.userId}`, {
    method: "DELETE",
    headers: {
      Authorization: localStorage.getItem("token")
...
// 获取组织基本信息
export async function getOrganiztion() {
  return request(prefix + "/identity/organization/base", {
    method: "GET",
    headers: {
      Authorization: localStorage.getItem("token")
    }
...
// 设置组织信息
export async function addOrganiztion(params) {
  return request(prefix + "/identity/organization", {
    method: "POST",
    body: params,
    headers: {
      Authorization: localStorage.getItem("token")
...
// 更新组织信息
export async function updateOrganiztion(params) {
  return request(prefix + `/identity/organization`, {
    method: "PUT",
    body: params,
    headers: {
...
// 删除组织
export async function deleteOrganiztion() {
  return request(prefix + "/identity/organization", {
    method: "DELETE",
    headers: {
      Authorization: localStorage.getItem("token")
...
export async function getPeer() {
  return request(prefix + "/identity/peer", {
    method: "GET",
    headers: {
      Authorization: localStorage.getItem("token")
    }
...
// 更新peer节点信息
export async function updatePeer(params) {
  return request(prefix + `/identity/peer/${params.peerId}`, {
    method: "PUT",
    body: params.data,
    headers: {
      Authorization: localStorage.getItem("token")
...
// 获取order节点的全部信息
export async function getOrderer() {
  return request(prefix + "/identity/orderer", {
    method: "GET",
    headers: {
      Authorization: localStorage.getItem("token")
    }
...
// 新增order节点信息
export async function addOrderer(params) {
  return request(prefix + "/identity/orderer", {
    method: "POST",
    body: params,
    headers: {
...
// 更新order节点信息
export async function updateOrderer(params) {
  return request(prefix + `/identity/orderer/${params.ordererId}`, {
    method: "PUT",
    body: params.data,
    headers: {
      Authorization: localStorage.getItem("token")
...
// 删除order节点信息
export async function deleteOrderer(params) {
  return request(prefix + `/identity/orderer/${params.ordererId}`, {
    method: "DELETE",
    headers: {
      Authorization: localStorage.getItem("token")
...
// 不动产定制化接口
export async function addDbcMember(params) {
  return request(prefix + `/bdc/member`, {
    method: "POST",
    body: params,
    headers: {
      Authorization: localStorage.getItem("token")
...
export async function createDbcMember(params) {
  return request(prefix + `/bdc/organization`, {
    method: "POST",
    body: params,
    headers: {
      Authorization: localStorage.getItem("token")
