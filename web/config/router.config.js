  ...
  // app
  {
    ...
    routes: [
      ...
      // identity
      {
        ...
        icon: 'form',
        routes: [
          { path: '/identity', redirect: '/identity/PeerManager' },
          {
            path: '/identity/PeerManager',
            name: 'PeerManager',
            component: './Identity/PeerManager'
          },
          {
            path: '/identity/OrdererManager',
            name: 'OrdererManager',
            component: './Identity/OrdererManager'
          },
          {
            path: '/identity/OrganizationManager',
            name: 'OrganizationManager',
            component: './Identity/OrganizationManager'
          },
          {
            path: '/identity/UserManager',
            name: 'UserManager',
            component: './Identity/UserManager'
          }
        ]
      },
      // channel
