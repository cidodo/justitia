...
public class FileUtils extends org.apache.commons.io.FileUtils {
     ...
     * @param dirPath 文件路径
     */
    public static boolean makeDirectory(String dirPath) throws IOException {
        File file = new File(dirPath);
        if (!file.exists()) {
            fileProber(file);
            if (!file.mkdirs()) {
                throw new IOException(String.format("Directory %s create error.", file.getPath()));
            }
        }
        return true;
    }
    ...
    public static void createFile(File file) throws IOException {
        ...
        if(!file.createNewFile()) {
            throw new IOException(String.format("File %s create error.", file.getPath()));
        }
    }
    ...
    public static File createTempFile(String fileName) throws IOException {
        ...
        String output = temp + System.currentTimeMillis() + random + File.separator + fileName;
    ...
    public static File createTempDirectory() throws IOException {
        ...
        int random = (int) (Math.random() * 1000);
        String output = temp + System.currentTimeMillis() + random + File.separator;
